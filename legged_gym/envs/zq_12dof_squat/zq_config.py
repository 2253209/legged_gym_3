...
class Zq12Cfg(LeggedRobotCfg):
    ...
    class init_state(LeggedRobotCfg.init_state):
        pos = [0.0, 0.0, 0.832]  # x,y,z [m] accurate:0.832
    ...
    class control(LeggedRobotCfg.control):
        ...
        # damping = {'JOINT': 0.0}
        stiffness = {'JOINT_Y1': 160.0, 'JOINT_Y2': 160.0, 'JOINT_Y3': 160.0, 'JOINT_Y4': 160.0, 'JOINT_Y5': 36.0, 'JOINT_Y6': 36.0,
                     'JOINT_Z1': 160.0, 'JOINT_Z2': 160.0, 'JOINT_Z3': 160.0, 'JOINT_Z4': 160.0, 'JOINT_Z5': 36.0, 'JOINT_Z6': 36.0,
                     }  # [N*m/rad]
